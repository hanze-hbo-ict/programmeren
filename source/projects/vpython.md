...
[Deze pagina bevat een aantal functies die je misschien wilt gebruiken, proberen of aanpassen...](/support/vpython). Hij bevat nu:
...
* {download}`Dit bestand vpython_events.py is een voorbeeld van een manier om beweging, toetsaanslagen en muisevents te verwerken. <assets/vpython_events.py>`
