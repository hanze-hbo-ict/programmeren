...
- {download}`Het Java-applicatiebestand: logisim-evolution-3.3.4-all.jar <assets/logisim-evolution-3.3.4-all.jar>`
- {download}`Het startbestand (pakt dit uit en gebruik het!): wk6ex1-4.circ.zip <assets/wk6ex1-4.circ.zip>`
