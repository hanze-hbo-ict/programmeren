...
| Herhaling | **lus** | loop (23×), herhaling (10×) | Maar wél *begrensde* en *onbegrensde herhaling* als vaste term; zie hieronder |
...
## Begrensde en onbegrensde herhaling

Voor het onderwerp van een lus schrijven we **lus** en niet *herhaling*, zoals de
tabel hierboven zegt. Maar *begrensde herhaling* en *onbegrensde herhaling* zijn
wél vaste termen: zij staan in `curriculum/leeruitkomsten.md` als PGM2 P1
("Student past begrensde en onbegrensde lusconstructies toe") en zij dragen het
onderscheid dat het lusrecept nodig heeft - bij een `for` ligt het aantal
herhalingen vast voordat de lus begint, bij een `while` levert de schrijver het
stopmoment.

Wat er in geen geval mag staan is *oneindige herhaling* voor `while`. Die
formulering is uit CS5 overgeërfd, is onjuist, en is bij de herziening van week 4
verwijderd.
