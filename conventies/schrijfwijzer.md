...
- Gebruik voor een gedachtestreep spatie-koppelteken-spatie ( - ). **Geen
  ...
  Het verbod op de em-dash geldt voor wat gepubliceerd wordt: het boek, dus
  `source/` (zie *Reikwijdte* in [conventies.md](conventies.md)). In interne
  documenten buiten het boek, zoals die in `curriculum/`, `conventies/` en
  `onderzoek/`, mag de em-dash wel. Vastgesteld door de vakdeskundige op 24
  september 2026, naar aanleiding van de beoordeling van PR #291.
