...
1. **De acceptatiecriteria**: gehaald en aangetoond, of niet. Dat weegt zwaarder
   dan al het andere.
2. **Het werkelijke risico**: wat gaat er mis, voor wie, hoe zichtbaar, en hoe
   makkelijk te herstellen als dit fout is? Materiaal is bijna altijd te
   repareren voordat het college begint; dat weegt mee.
3. **Scheid streng**: moet veranderen (de student loopt vast of leert iets
   onjuists), zou moeten veranderen (veel waarde, weinig moeite), puntjes (smaak).
4. Gebruik `AKKOORD MET PUNTJES` voor werk dat goed genoeg is met goedkope
   verbeteringen, en `AKKOORD` ruimhartig wanneer de criteria zijn gehaald.
   `BLOKKEER` alleen bij een echte moet-bevinding.
